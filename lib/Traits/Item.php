 ...
 * Limbonia Item Trait
 *
 * This trait allows an inheriting class to act as an item from a database
 *
...
trait Item
{
     ...
     */
    public static function factory($sTable, \Limbonia\Database $oDatabase = null)
    {
     ...
     * @return \Limbonia\Item
     */
    public static function typeFactory( \Limbonia\Database $oDatabase = null)
    {
     ...
     * @return \Limbonia\Item
     */
    public static function fromId($sTable, $iItem, \Limbonia\Database $oDatabase = null)
    {
     ...
     * @return \Limbonia\Item
     */
    public static function typeFromId($iItem, \Limbonia\Database $oDatabase = null)
    {
     ...
     * @throws \Exception
     */
    public static function fromArray($sTable, array $hItem, \Limbonia\Database $oDatabase = null)
    {
      $oItem = static::factory($sTable, $oDatabase);
      $oItem->setAll($hItem);
      return $oItem;
     ...
     * @throws \Exception
     */
    public static function typeFromArray(array $hItem, \Limbonia\Database $oDatabase = null)
    {
    ...
    public static function getList($sType, $sQuery, \Limbonia\Database $oDatabase = null)
    {
      ...
      $oList = new \Limbonia\ItemList($sType, $oDatabase->query($sQuery));
     ...
     * @return \Limbonia\ItemList
     */
    public static function typeList($sQuery = '', \Limbonia\Database $oDatabase = null)
    {
     ...
     * @param \Limbonia\Database $oDatabase (optional) - The \Limbonia\Database to perform the search in
     * @return \Limbonia\ItemList
     */
    public static function search($sType, $hWhere = [], $xOrder = null, \Limbonia\Database $oDatabase = null)
    {
     ...
     * @return \Limbonia\ItemList
     */
    public static function typeSearch($hWhere = [], $xOrder = null, \Limbonia\Database $oDatabase = null)
    {
    ...
    public function setup()
    {
      if (static::type() == '')
      {
        throw new \Exception("The base " . static::classType() . " class can not set up tables!");
      }
    ...
    protected function formatInput($sColumn, $xValue)
    {
      ...
      switch ($sType)
      {
        ...
        default:
          return \Limbonia\Database::filterValue($sType, $xValue);
      }
    }
